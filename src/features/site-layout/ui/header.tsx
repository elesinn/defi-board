        ...
        <div className="flex flex-1">
          <form className="flex w-full md:ml-0" action="#" method="GET">
            ...
            <div className="relative w-full text-gray-600 focus-within:text-main-500">
              ...
              <input
                id="search-field"
                className="block w-full h-full py-2 pl-9 pr-3 text-gray-900 placeholder-gray-500 border-transparent focus:outline-none focus:placeholder-gray-400 focus:ring-0 focus:border-transparent sm:text-sm bg-main-200 rounded-lg"
